//-*- coding: utf-8; mode: c++ -*-
// Time-stamp: <2015-12-30 14:35:21 shunta>
...
//   beta: 逆温度
//
void Zigzag::output(ofstream& physical_quantities, vector<Complex> order, double haf, double mu, double q, double T, double beta) {
  double k;                                           // 波数
#ifdef _OPENMP
  Zigzag::Zmatrix zmatrix;                            // 複素数行列
#else
