//-*- coding: utf-8; mode: c++ -*-
// Time-stamp: <2016-01-28 16:03:36 shunta>
...
//#include <boost/numeric/ublas/hermitian.hpp>  // エルミート行列用のヘッダ
...
namespace Zigzag {
  ...
  const Cvector order_zero
  = zero_vector<Complex>(2);                    // ゼロギャップ
  static double t[2];                           // 飛び移り積分(hoppingのパラメータ)
